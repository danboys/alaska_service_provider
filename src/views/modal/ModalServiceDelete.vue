        ...
        <div class="card card_modify">
          ...
          <div class="card-body">
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  <p class="help-block c_light_blue">{{service.serviceName}} 분류가 삭제 완료되었습니다.</p>
                </div>
              </div>
            </div>
          </div><!--//card-body-->
...
<script>
  ...
  export default {
    ...
    created() {
      console.log('ModalServiceDelete ::');
